...
export const getAddUserIds = (currnetUserFriendsIds: string[], person: Person, currentUserId: string) => {
...
export const getDeleteUserids = (currnetUserFriendsIds: string[], person: Person, currentUserId: string) => {
