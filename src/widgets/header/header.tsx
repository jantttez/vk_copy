...
import { DropDownContent } from '@components/index';
...
import { VkLogo } from '@entities/header/ui';
import { HeaderPopup } from '@entities/header/ui/popup';
  ...
  return (
    <header className={styles.header}>
      ...
      <div className={styles.searchContainer} ref={searchRef}>
        ...
        {loading ? <Spinner /> : isFocused ? <HeaderPopup people={data['users']} /> : null}
      </div>
